Gem::Specification.new do |s|
  ...
  s.files = ["lib/dynamic_active_resource/associations/base.rb", "lib/dynamic_active_resource/associations/belongs_to.rb", "lib/dynamic_active_resource/associations/has_many.rb", 
    ...
    "spec/dynamic_active_resource/base_spec.rb", "spec/dynamic_active_resource/common_dynamic_class_instance_methods_spec.rb", "spec/dynamic_active_resource/version_spec.rb", 'README', 'History.txt', 'init.rb']
  s.require_paths = ['lib']
