Gem::Specification.new do |s|
  ...
  s.files = ["lib/dynamic_active_resource/associations/base.rb", "lib/dynamic_active_resource/associations/belongs_to.rb", "lib/dynamic_active_resource/associations/has_many.rb", 
    "lib/dynamic_active_resource/associations.rb", "lib/dynamic_active_resource/base.rb", "lib/dynamic_active_resource/common_class_methods.rb", "lib/dynamic_active_resource/common_dynamic_class_instance_methods.rb", "lib/dynamic_active_resource/helpers.rb", "lib/dynamic_active_resource/version.rb",
    "lib/dynamic_active_resource.rb"] + ['README', 'History.txt', 'init.rb']
  s.require_paths = ['lib']
